vim.keymap.set('n', '<C-gi>', ':Neotree source=git_status toggle<CR>', { desc = "Show Git Status" })
vim.keymap.set('n', '<C-bu>', ':Neotree source=buffers toggle<CR>', { desc = "Show Buffers" })
